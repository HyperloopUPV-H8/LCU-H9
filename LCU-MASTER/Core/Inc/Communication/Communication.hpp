...
public:
	...
	static void start_ethernet(){
		...
		EthernetOrders[TESTING_SET_STABLE_LEVITATION_ON_TCP_ORDER_INDEX+(i*ETH_ORDER_BYPASS_INDEX_TO_ADD)] = new StackOrder(TESTING_SET_STABLE_LEVITATION_ON_TCP_ORDER_ID+(i*ETH_ORDER_BYPASS_ID_TO_ADD), set_stable_levitation_on);
		EthernetOrders[TESTING_SET_STABLE_LEVITATION_OFF_TCP_ORDER_INDEX+(i*ETH_ORDER_BYPASS_INDEX_TO_ADD)] = new StackOrder(TESTING_SET_STABLE_LEVITATION_OFF_TCP_ORDER_ID+(i*ETH_ORDER_BYPASS_ID_TO_ADD), set_stable_levitation_off);
		EthernetOrders[RESET_TCP_ORDER_INDEX+(i*ETH_ORDER_BYPASS_INDEX_TO_ADD)] = new StackOrder(RESET_TCP_ORDER_ID+(i*ETH_ORDER_BYPASS_ID_TO_ADD), reset_cycle);
	...
	void define_packets(){
		...
		SPIPackets[TESTING_SET_STABLE_LEVITATION_ON_ORDER_INDEX*2] = new SPIPacket<0>;
		SPIPackets[TESTING_SET_STABLE_LEVITATION_ON_ORDER_INDEX*2+1] = new SPIPacket<0>;
		SPIOrders[TESTING_SET_STABLE_LEVITATION_ON_ORDER_INDEX] = new SPIStackOrder(TESTING_SET_STABLE_LEVITATION_ON_ORDER_ID, *SPIPackets[TESTING_SET_STABLE_LEVITATION_ON_ORDER_INDEX*2], *SPIPackets[TESTING_SET_STABLE_LEVITATION_ON_ORDER_INDEX*2+1]);


		SPIPackets[TESTING_SET_STABLE_LEVITATION_OFF_ORDER_INDEX*2] = new SPIPacket<0>;
		SPIPackets[TESTING_SET_STABLE_LEVITATION_OFF_ORDER_INDEX*2+1] = new SPIPacket<0>;
		SPIOrders[TESTING_SET_STABLE_LEVITATION_OFF_ORDER_INDEX] = new SPIStackOrder(TESTING_SET_STABLE_LEVITATION_OFF_ORDER_ID, *SPIPackets[TESTING_SET_STABLE_LEVITATION_OFF_ORDER_INDEX*2], *SPIPackets[TESTING_SET_STABLE_LEVITATION_OFF_ORDER_INDEX*2+1]);


		SPIPackets[RESET_ORDER_INDEX*2] = new SPIPacket<0>;
		SPIPackets[RESET_ORDER_INDEX*2+1] = new SPIPacket<0>;
		SPIOrders[RESET_ORDER_INDEX] = new SPIStackOrder(RESET_ORDER_ID, *SPIPackets[RESET_ORDER_INDEX*2], *SPIPackets[RESET_ORDER_INDEX*2+1]);
...
if constexpr(USING_5DOF){
	...
	static void set_stable_levitation_on(){
		SPI::master_transmit_Order(spi_id, SPIBaseOrder::SPIOrdersByID[TESTING_SET_STABLE_LEVITATION_ON_ORDER_ID]);
	}

	static void set_stable_levitation_off(){
		SPI::master_transmit_Order(spi_id, SPIBaseOrder::SPIOrdersByID[TESTING_SET_STABLE_LEVITATION_OFF_ORDER_ID]);
	}

	static void reset_cycle(){
		SPI::master_transmit_Order(spi_id, SPIBaseOrder::SPIOrdersByID[RESET_ORDER_ID]);
	}
