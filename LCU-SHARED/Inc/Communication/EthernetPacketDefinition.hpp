...
static constexpr uint32_t ETH_ORDER_COUNT = 17 *2; //duplicated for bypass versions
...
static constexpr uint16_t TEST_PWM_TCP_ORDER_INDEX = 2;

static constexpr uint16_t TEST_DESIRED_CURRENT_TCP_ORDER_ID = 352;
static constexpr uint16_t TEST_DESIRED_CURRENT_TCP_ORDER_INDEX = 3;

static constexpr uint16_t TEST_START_RESET_TCP_ORDER_ID = 353;
static constexpr uint16_t TEST_START_RESET_TCP_ORDER_INDEX = 4;

static constexpr uint16_t TEST_STOP_RESET_TCP_ORDER_ID = 354;
static constexpr uint16_t TEST_STOP_RESET_TCP_ORDER_INDEX = 5;

static constexpr uint16_t START_LEVITATION_CONTROL_TCP_ORDER_ID = 355;
static constexpr uint16_t START_LEVITATION_CONTROL_TCP_ORDER_INDEX = 6;

static constexpr uint16_t START_VERTICAL_LEVITATION_TCP_ORDER_ID = 356;
static constexpr uint16_t START_VERTICAL_LEVITATION_TCP_ORDER_INDEX = 7;

static constexpr uint16_t STOP_LEVITATION_TCP_ORDER_ID = 357;
static constexpr uint16_t STOP_LEVITATION_TCP_ORDER_INDEX = 8;

static constexpr uint16_t STICK_DOWN_TCP_ORDER_ID = 358;
static constexpr uint16_t STICK_DOWN_TCP_ORDER_INDEX = 9;

static constexpr uint16_t LANDING_TCP_ORDER_ID = 359;
static constexpr uint16_t LANDING_TCP_ORDER_INDEX = 10;

static constexpr uint16_t START_HORIZONTAL_LEVITATION_TCP_ORDER_ID = 360;
static constexpr uint16_t START_HORIZONTAL_LEVITATION_TCP_ORDER_INDEX = 11;

static constexpr uint16_t ENTER_TESTING_MODE_TCP_ORDER_ID = 361;
static constexpr uint16_t ENTER_TESTING_MODE_TCP_ORDER_INDEX = 12;

static constexpr uint16_t EXIT_TESTING_MODE_TCP_ORDER_ID = 362;
static constexpr uint16_t EXIT_TESTING_MODE_TCP_ORDER_INDEX = 13;

static constexpr uint16_t TESTING_SET_STABLE_LEVITATION_ON_TCP_ORDER_ID = 363;
static constexpr uint16_t TESTING_SET_STABLE_LEVITATION_ON_TCP_ORDER_INDEX = 14;

static constexpr uint16_t TESTING_SET_STABLE_LEVITATION_OFF_TCP_ORDER_ID = 364;
static constexpr uint16_t TESTING_SET_STABLE_LEVITATION_OFF_TCP_ORDER_INDEX = 15;

static constexpr uint16_t RESET_TCP_ORDER_ID = 365;
static constexpr uint16_t RESET_TCP_ORDER_INDEX = 16;
