...
static constexpr uint32_t ETH_ORDER_COUNT = 13;
...
static const uint16_t STABLE_LEVITATION_CONFIRMATION_TCP_ORDER_ID = 341;
static constexpr uint16_t STABLE_LEVITATION_CONFIRMATION_TCP_ORDER_INDEX = FIRST_ETH_TESTING_ORDER_INDEX+10;

static const uint16_t LANDING_COMPLETE_CONFIRMATION_TCP_ORDER_ID = 342;
static constexpr uint16_t LANDING_COMPLETE_CONFIRMATION_TCP_ORDER_INDEX = FIRST_ETH_TESTING_ORDER_INDEX+11;
