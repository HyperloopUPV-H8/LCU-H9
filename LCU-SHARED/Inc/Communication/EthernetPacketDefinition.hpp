...
static constexpr uint16_t ENTER_TESTING_MODE_TCP_ORDER_INDEX = FIRST_ETH_TESTING_ORDER_INDEX+10;

static constexpr uint16_t EXIT_TESTING_MODE_TCP_ORDER_ID = 362;
static constexpr uint16_t EXIT_TESTING_MODE_TCP_ORDER_INDEX = FIRST_ETH_TESTING_ORDER_INDEX+11;
