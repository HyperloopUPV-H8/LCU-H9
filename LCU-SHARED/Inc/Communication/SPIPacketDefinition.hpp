...
static constexpr uint16_t ENTER_TESTING_MODE_ORDER_INDEX = FIRST_TESTING_ORDER_INDEX+5;

static constexpr uint16_t EXIT_TESTING_MODE_ORDER_ID = 1009;
static constexpr uint16_t EXIT_TESTING_MODE_ORDER_INDEX = FIRST_TESTING_ORDER_INDEX+6;
