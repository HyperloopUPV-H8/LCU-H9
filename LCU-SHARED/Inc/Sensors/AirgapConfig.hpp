...
static constexpr float FLOAT_EMS_AIRGAP_SLOPE =  1.0;//0.03/3.3; //temporal profile of the sensor for HIL purposes
static constexpr float FLOAT_EMS_AIRGAP_OFFSET = 0.0;//0.120;
