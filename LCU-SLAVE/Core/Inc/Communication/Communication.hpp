...
public:
	...
	void define_packets(){
		...
		SPIOrders[TESTING_SET_STABLE_LEVITATION_ON_ORDER_INDEX]->set_callback(set_stable_levitation_on);
		...
		SPIOrders[TESTING_SET_STABLE_LEVITATION_OFF_ORDER_INDEX]->set_callback(set_stable_levitation_off);
		...
		SPIOrders[RESET_ORDER_INDEX]->set_callback(reset);
	}
