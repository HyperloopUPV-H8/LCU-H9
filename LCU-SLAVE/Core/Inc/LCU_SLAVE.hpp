...
if constexpr(USING_5DOF){
		...
		ldu_array[5] = LDU<running_mode, arithmetic_number_type>();//LDU<running_mode, arithmetic_number_type>(5, PWM_PIN_6_1, PWM_PIN_6_2, VBAT_PIN_6, SHUNT_PIN_6, KP_EMS_CURRENT_TO_DUTY, KI_EMS_CURRENT_TO_DUTY);
